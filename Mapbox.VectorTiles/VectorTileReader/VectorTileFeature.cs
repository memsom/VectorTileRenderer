    ...
    public class VectorTileFeature
    {
        ...
        public Dictionary<string, object> GetProperties()
        {
            ...
            for (int i = 0; i < tagCount; i += 2)
            {
                ...
                var tag = _layer.Values[Tags[i + 1]];
                try
                {
                ...
                catch (Exception)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine($"Duplicate key '{key}' for feature '{tag}'");
                    System.Diagnostics.Debug.WriteLine($"Used key '{key}' for feature '{properties[key]}'");
                }				
            }
            return properties;
        }
